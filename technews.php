...
$articles = "SELECT * FROM blog WHERE tag LIKE 'Tech News' LIMIT $start, $perPage";
...
if(isset($_GET['cari'])){
 ...
 <script type="text/javascript">
   swal("Halo!", "Selamat datang pada tag Tech News JarKom!", "success")
 </script>
<br>
 <body>
   <span class="glyphicon glyphicon-tags" aria-hidden="true" style="color:rgba(235, 126, 152, 1); margin-left:20px"><h1 class="kategori">Tech-News</h1></span>
 </body>

 <form class="navbar-form navbar-right pencarian" role="search" method="get" action="">
   <div class="form-group">
       <input type="search" class="form-control" placeholder="Cari disini gan!" name="cari">
   </div>
   <button type="submit" class="btn btn-primary">Cari</button>
   <br>
   <a href="technews.php">Muat Ulang</a>
 </form>
...
<style>
  ...
  .kategori{
    color: rgba(235, 126, 152, 1);
    margin-left: 20px;
  }
  .kategori:hover{
    color: rgba(235, 126, 152, 0.5);
  }
  .ukuran{
    padding-left: 10px;
    padding-right: 230px;
